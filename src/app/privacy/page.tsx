  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl space-y-6 px-6 py-20 text-neutral-700 leading-relaxed md:py-28">
        ...
        <h2 className="mt-10 font-display text-2xl text-fg uppercase">What we collect</h2>
        <p>
        ...
        <h2 className="mt-10 font-display text-2xl text-fg uppercase">Your rights</h2>
        <p>
